...
namespace M101DotNet.WebApp.Controllers
{
    public class HomeController : Controller
    {
        public async Task<ActionResult> Index()
        {
            ...
            var recentPosts = await blogContext
                .Posts
        ...
        public async Task<ActionResult> Post(string id)
        {
            ...
            var post = await blogContext.Posts.Find(x => x.Id == ObjectId.Parse(id)).FirstAsync();
        ...
        public async Task<ActionResult> NewComment(NewCommentModel model)
        {
            ...
            var updateModel = Builders<Post>.Update.Push("Comments", comment);
            await blogContext.Posts.UpdateOneAsync(x => x.Id == ObjectId.Parse(model.PostId), updateModel);
            return RedirectToAction("Post", new { id = model.PostId });
        }
    }
}